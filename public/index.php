...
<body class="bg-white">
    ...
    <main class="p-0">
        ...
        <section class="flex flex-col items-center bg-red-600 text-white py-8 px-40 ">
            <div class="w-full text-center mb-8">
                <h2 class="text-3xl font-bold">Jangan kelewatan Promonya!</h2>
            ...
            <div class="w-full relative overflow-hidden">
                ...
                <div class="flex transition-transform duration-500" id="carousel">
                    ...
                    <div class="flex-shrink-0 w-full flex justify-center">
                        <img src="images/promo1.png" alt="Promo Image 1" class="rounded-lg w-auto h-auto">
                    </div>
                    <!-- Gambar 2 -->
                    <div class="flex-shrink-0 w-full flex justify-center">
                        <img src="images/promo1.png" alt="Promo Image 2" class="rounded-lg w-auto h-auto">
                    </div>
                    <!-- Gambar 3 -->
                    <div class="flex-shrink-0 w-full flex justify-center">
                        <img src="images/promo1.png" alt="Promo Image 3" class="rounded-lg w-auto h-auto">
                    </div>
                </div>

                <!-- Navigation buttons (next & prev) -->
                <button onclick="moveCarousel('prev')" class="absolute left-5 top-1/2 transform -translate-y-1/2 bg-white text-red-600 p-2 rounded-full shadow-lg z-10 hover:bg-red-100">
                    &#10094;
                </button>
                <button onclick="moveCarousel('next')" class="absolute right-5 top-1/2 transform -translate-y-1/2 bg-white text-red-600 p-2 rounded-full shadow-lg z-10 hover:bg-red-100">
                    &#10095;
                </button>
            </div>
            ...
            <div class="flex justify-center mt-4">
                <button onclick="moveCarousel(0)" class="carousel-dot active-dot"></button>
                <button onclick="moveCarousel(1)" class="carousel-dot"></button>
                <button onclick="moveCarousel(2)" class="carousel-dot"></button>
            </div>
        </section>
        ...
        <section class="flex items-center px-40">
            ...
            <div class="w-full text-red-600 py-10">
                ...
                <a href="kemitraan.html" class="bg-red-600 text-white  hover:bg-red-800 font-bold px-6 py-2 rounded-full mt-4 inline-block">Gabung Kemitraan</a>
            </div>
        </section>
    ...
    <section class="bg-red-600 text-white text-center">
        ...
        <p class="text-sm mt-4">Nikmati Setiap Momen Manis dengan Bonbon Ice Cream, Tea, and Coffee. Temukan Produk Favorit Anda dan Rasakan Kenikmatan</p>
        <!-- Menu Items Grid -->
    ...
    <section class="text-center py-20 px-4 relative bg-red-600">
        ...
        <div class="relative overflow-hidden px-20 max-w-screen-lg mx-auto">
            ...
            <!-- Testimonial 1 -->
            <div class="w-[300px] bg-white p-6 rounded-lg shadow-lg text-left shrink-0">
                <h3 class="text-xl font-bold text-red-600">dipa</h3>
                <p class="text-sm text-gray-700 mt-4">BONBON eskrimnya enak banget, teksturnya lembut!</p>
            </div>
            <!-- Testimonial 2 -->
            <div class="w-[300px] bg-white p-6 rounded-lg shadow-lg text-left shrink-0">
                <h3 class="text-xl font-bold text-red-600">ney</h3>
                <p class="text-sm text-gray-700 mt-4">Tempatnya lucu dan banyak varian, wajib coba!</p>
            </div>
            <!-- Testimonial 3 -->
            <div class="w-[300px] bg-white p-6 rounded-lg shadow-lg text-left shrink-0">
                <h3 class="text-xl font-bold text-red-600">icam</h3>
                <p class="text-sm text-gray-700 mt-4">Varian menunya lengkap banget</p>
            </div>
            <!-- Testimonial 2 -->
            <div class="w-[300px] bg-white p-6 rounded-lg shadow-lg text-left shrink-0">
                <h3 class="text-xl font-bold text-red-600">Amir</h3>
                <p class="text-sm text-gray-700 mt-4">Enak dan harga ramah untuk pelajar</p>
            </div>
            </div>
