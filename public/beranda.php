...
<body class="bg-white">
        ...
        <section class="bg-red-600 text-white text-center">
            ...
            <section id="daftar-menu" class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-8 py-8 px-40">
                ...
                foreach ($menus as $menu) : ?>
                    <a href="menu.php?kategori=<?= $menu['kategori'] ?>" class="block transform transition duration-300 hover:scale-105">
    ...
    <script>
        ...
        function moveTestimonial(direction) {
            ...
            const cardWidth = cards[0].offsetWidth + 24; // 24px gap (space-x-6)
