...
<body class="bg-red-600 ">
    ...
    <header class="text-center py-16 text-red-600 bg-white">
        ...
        <p class="mt-4 text-xl px-60 py-2">Nikmati Setiap Momen Manis dengan Bonbon Ice Cream, Tea & Coffee. Temukan Produk Favorit Anda dan Rasakan Kenikmatan</p>
    </header>

    <!-- Navigation Categories -->
    <nav class="category-nav">
        <a href="#semua" class="category-link active" data-category="semua">Semua</a>
        <a href="#coffee-series" class="category-link" data-category="coffee-series">Coffee Series</a>
        <a href="#waffle-cone" class="category-link" data-category="waffle-cone">Waffle Cone</a>
        <a href="#float" class="category-link" data-category="float">Float</a>
        <a href="#signature" class="category-link" data-category="signature">Signature</a>
        <a href="#sundae" class="category-link" data-category="sundae">Sundae</a>
        <a href="#tea-series" class="category-link" data-category="tea-series">Tea Series</a>
    </nav>
    ...
    <section id="semua" class="category-section active">
        ...
        <!-- Menu Item coffee -->
            <div class="bg-white rounded-lg overflow-hidden shadow-lg p-4 block transform transition duration-300 hover:scale-105">
                ...
                <div class="text-left mt-4">
                    <p class="font-bold text-xl text-black">Strawberry Sundae</p>
                    <p class="text-red-600 font-bold text-base mt-1 border-2 border-red-600 rounded-full inline-block py-1 px-3">Rp 100.000</p>
                </div>
            </div>

        <section id="waffle-cone" class="category-section hidden"></section>
            <!-- Menu Item 2 -->
            <div class="bg-white rounded-lg overflow-hidden shadow-lg p-4 block transform transition duration-300 hover:scale-105">
                <img src="images/strobericone.svg" alt="Strawberry Sundae" class="w-36 h-48 object-cover mx-auto">
                <div class="text-left mt-4">
                    <p class="font-bold text-xl text-black">Strawberry Sundae</p>
                    <p class="text-red-600 font-bold text-base mt-1 border-2 border-red-600 rounded-full inline-block py-1 px-3">Rp 100.000</p>
                </div>
        ...
        <section id="float" class="category-section hidden"></section>
            <!-- Menu Item 3 -->
            <div class="bg-white rounded-lg overflow-hidden shadow-lg p-4 block transform transition duration-300 hover:scale-105">
                <img src="images/stroberisundae.svg" alt="Strawberry Sundae" class="w-36 h-48 object-cover mx-auto">
                <div class="text-left mt-4">
        ...
        <section id="signature" class="category-section hidden"></section>
            <!-- Menu Item 4 -->
            <div class="bg-white rounded-lg overflow-hidden shadow-lg p-4 block transform transition duration-300 hover:scale-105">
                <img src="images/stroberisundae.svg" alt="Strawberry Sundae" class="w-36 h-48 object-cover mx-auto">
                <div class="text-left mt-4">
    ...
    <script>
        ...
        // Ambil semua kategori dan menu
        const categoryLinks = document.querySelectorAll('.category-link');
        const categorySections = document.querySelectorAll('.category-section');

        // Menambahkan event listener pada setiap kategori link
        categoryLinks.forEach(link => {
            link.addEventListener('click', function(e) {
                e.preventDefault(); // Cegah default link behavior

                // Hilangkan class 'active' dari semua kategori
                categoryLinks.forEach(link => link.classList.remove('active'));

                // Tambahkan class 'active' pada kategori yang dipilih
        ...
        // Ketika kategori "Semua" diklik, tampilkan semua kategori
        const allCategoryLink = document.querySelector('.category-link[data-category="semua"]');
