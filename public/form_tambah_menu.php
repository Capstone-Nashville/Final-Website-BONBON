...
<head>
    ...
    <title>Tambah Menu BONBON</title>
...
<body>
    ...
    <main class="p-0 w-full">
        ...
        <section class="px-4 text-center items-center justify-center text-white bg-red-600">
            <h2 class="text-4xl font-bold">Tambah Menu</h2>
        </section>
        ...
        <section class="bg-red-600 justify-center w-full">
            <div class="flex justify-center items-center w-full p-8">
                <div class="bg-white p-8 rounded-xl shadow-xl w-full max-w-4xl">
                    ...
                    <form class="space-y-6" method="POST" action="../api/controller/aksi_tambah_menu.php" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input type="text" id="nama_menu" name="nama_menu" class="w-full p-3 border border-gray-300 rounded-md mt-2" placeholder="Masukkan Nama Menu" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="harga" name="harga" class="w-full p-3 border border-gray-300 rounded-md mt-2" placeholder="Masukkan Harga" required min="0" step="1000">
                        </div>

                        <div>
                            <label for="gambar" class="block text-sm font-medium text-gray-600">Gambar</label>
                            <input type="file" id="gambar" name="gambar" accept="image/*" class="w-full p-3 border border-gray-300 rounded-md mt-2" required>
                        </div>
