...
<body class="flex min-h-screen bg-red-600">
    ...
    <div class="bg-red-600 flex items-center justify-center w-2/3 p-8">
        <div class="bg-white p-8 rounded-xl shadow-xl w-full max-w-md">
            ...
            <form action="/bonbon/api/controller/aksi_register.php" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" required class="w-full p-3 border border-gray-300 rounded-md mt-2" placeholder="Masukkan email anda">
                </div>
                ...
                <div class="relative">
                    <label for="confirmPassword" class="block text-sm font-medium text-gray-600 mb-1">Konfirmasi Kata Sandi</label>
